    ...
    <section className="relative bg-light">
      <div className="mx-auto max-w-screen-2xl px-4 lg:px-6">
        <motion.div
          ...
          className="flex flex-col lg:flex-row gap-8 items-center lg:items-stretch justify-start lg:justify-center pt-12 lg:pt-0 lg:-translate-y-10"
        >
          <motion.div
            custom="left"
            variants={isMobile ? cardMobile : cardDesktop}
            className="flex flex-col gap-4 p-8 bg-light shadow-[0_20px_40px_rgba(0,0,0,0.15)] max-w-sm w-full"
          >
