...
function Federacao() {
  return (
    <section className="bg-light py-17 lg:py-26">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 justify-start lg:justify-center">
          ...
          >
            ...
            <p className="text-primary leading-relaxed">
              ...
              por regulamentar e desenvolver o Triathlon e suas variações no Rio
              Grande do Sul. Sua missão é fomentar o esporte, garantindo
